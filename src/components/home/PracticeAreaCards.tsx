        ...
        <div className="mx-auto grid max-w-[1200px] grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {practiceAreas.map((area) => (
            <Link
              ...
              className="border border-border-warm bg-parchment p-9 transition-all duration-200 hover:-translate-y-1 hover:border-gold hover:shadow-[0_14px_40px_rgba(13,27,42,0.18)]"
            >
